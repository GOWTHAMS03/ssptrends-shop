 ...
 */
 ...
 const ReturnOrderList = props => {
   const { returnOrder, approveReturnOrder, rejectReturnOrder, deleteReturnOrder } = props;
   ...
   const getProduct = returnOrder => {
     if (returnOrder.product) {
       const product = returnOrder.product;
       return (
