...
import Minisize from '../../components/Store/MiniSize';
          ...
          <Row className='align-items-center top-header'>
            ...
            >
              <div className='size'>
                ...
                <Link to='/'>
                  <img src='images/ssptrends.svg' className='logo '/>
                ...
                <Nav navbar>
                  {sizes && sizes.length > 0 && (
                    ...
                    >
                      ...
                      <DropdownMenu right className='nav-size-dropdown'>
...
const mapStateToProps = state => {
  return {
    ...
    issizeOpen: state.navigation.issizeOpen,
